...
`wreq-proto` is a client-focused fork of [Hyper], adapted for [wreq]. It incorporates upstream fixes and improvements to client and shared protocol code while maintaining its own runtime integrations and client APIs.
